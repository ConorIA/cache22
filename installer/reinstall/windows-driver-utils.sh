...
convert_file_to_utf8() {
    ...
    # UTF-16LE without BOM  windows  inf?

    # UTF-16LE with BOM
    if [ "$(head -c2 "$1")" = $'\xFF\xFE' ]; then
        # -f UTF-16LE -t UTF-8  UTF-8 BOM
...
# reinstall.sh  iso  32  64  mix_x86_x86_64  true
# trans.sh  iso  32  64  mix_x86_x86_64  false
list_files_from_inf() {
    local inf=$1
